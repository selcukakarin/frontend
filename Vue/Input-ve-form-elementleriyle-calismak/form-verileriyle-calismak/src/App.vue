              ...
              <div class="row">
                <div class="col-md-12">
                  <div class="form-group">
                    ...
                    :value="userData.username" @input="userData.username = $event.target.value">
                  </div>
                  <div class="form-group">
              ...
              <div class="row">
                <div class="col-md-12 from-group">
                  ...
                  <select v-model="userData.selectedCity" class="form-control">
                    <option :selected="city == 'sakarya'" v-for="city in userData.cities">{{city}}</option>
                  </select>
                </div>
              </div>
              <hr>
    ...
    data() {
      return {
        userData : {
          ...
          interest : [],
          gender : '',
          cities : ["istanbul", "izmir", "aydın", "sakarya"],
          selectedCity : 'sakarya'
        },
        switched :true,
        isSubmitted : false
      }
